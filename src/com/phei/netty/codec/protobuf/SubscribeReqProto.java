...
public final class SubscribeReqProto {
  ...
  public interface SubscribeReqOrBuilder
    ...
    /**
     * <code>required string broductName = 3;</code>
     */
    boolean hasBroductName();
    /**
     * <code>required string broductName = 3;</code>
     */
    String getBroductName();
    /**
     * <code>required string broductName = 3;</code>
     */
    com.google.protobuf.ByteString
  ...
  public static final class SubscribeReq extends
    ...
    // required string broductName = 3;
    public static final int BRODUCTNAME_FIELD_NUMBER = 3;
    private Object broductName_;
    /**
     * <code>required string broductName = 3;</code>
     */
    public boolean hasBroductName() {
      return ((bitField0_ & 0x00000004) == 0x00000004);
    }
    /**
     * <code>required string broductName = 3;</code>
     */
    public String getBroductName() {
      Object ref = broductName_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeBytes(3, getBroductNameBytes());
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(3, getBroductNameBytes());
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public SubscribeReq buildPartial() {
        ...
        result.broductName_ = broductName_;
      ...
      public Builder mergeFrom(SubscribeReq other) {
        ...
        if (other.hasBroductName()) {
          bitField0_ |= 0x00000004;
          broductName_ = other.broductName_;
          onChanged();
        }
        if (other.hasAddress()) {
          bitField0_ |= 0x00000008;
  ...
  bitField0_ |= 0x00000004;
       ...
       * <code>required string broductName = 3;</code>
       */
      public Builder clearBroductName() {
        bitField0_ = (bitField0_ & ~0x00000004);
        broductName_ = getDefaultInstance().getBroductName();
        onChanged();
        return this;
      }
      /**
       * <code>required string broductName = 3;</code>
       */
      public Builder setBroductNameBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ...
  static {
    String[] descriptorData = {
      ...
      " \002(\t\022\023\n\013broductName\030\003 \002(\t\022\017\n\007address\030\004 \002" +
      "(\tB\037\n\035com.phei.netty.codec.protobuf"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_netty_SubscribeReq_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_netty_SubscribeReq_descriptor,
              new String[] { "SubReqId", "UserName", "BroductName", "Address", });
          return null;
        }
      };
